                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="Facebook" placeholder="facebok" name="Facebook">
                      </div>
                      <div class="form-group">
                        <label for="Instagram">Instagram</label>
                        <input type="password" class="form-control" id="Instagram" placeholder="Instagram" name="Instagram">
                      </div>
                      <div class="form-group">
                        <label for="LinkedIn">LinkedIn</label>
                        <input type="password" class="form-control" id="LinkedIn" placeholder="LinkedIn" name="LinkedIn">
                      </div>
                      <div class="form-group">
                        <label for="Github">Github</label>
                        <input type="password" class="form-control" id="Github" placeholder="github" name="Github">
                      </div>
                      <div class="form-group">
                        <label for="Address">Address</label>
                        <input type="password" class="form-control" id="Address" placeholder="Input your Address" name="Address">
                      </div>
                      <div class="form-group">
                        <label for="Phone">Phone</label>
                        <input type="password" class="form-control" id="Phone" placeholder="Input your Phone no." name="Phone">
                      </div>
